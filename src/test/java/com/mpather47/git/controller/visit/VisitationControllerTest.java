...
public class VisitationControllerTest {
    ...
    public void a_create() {
        ...
        ResponseEntity<Visitation> posResponse = restTemplate
                .withBasicAuth(SECURITY_USERNAME,SECURITY_PASSWORD)
                .postForEntity(url, visitation, Visitation.class);
    ...
    public void b_read() {
        ...
        System.out.println("URL: " + url);
        ResponseEntity<Visitation> response = restTemplate.
                 withBasicAuth(SECURITY_USERNAME,SECURITY_PASSWORD)
                .getForEntity(url,Visitation.class);
    ...
    public void c_update() {
        ...
        ResponseEntity<Visitation> response = restTemplate
                .withBasicAuth(SECURITY_USERNAME,SECURITY_PASSWORD)
                .postForEntity(url,updated, Visitation.class);
