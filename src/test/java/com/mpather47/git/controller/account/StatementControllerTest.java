...
public class StatementControllerTest {
    ...
    private static Statement statement = StatementFactory.createStatement("10/10/2010",80000.00, AccountFactory.createAccount(7656788.98,"Sale"));
    ...
    public void a_create() {
        ...
        ResponseEntity<Statement> postResponse = restTemplate
                .withBasicAuth(SECURITY_USERNAME,SECURITY_PASSWORD)
                .postForEntity(url,statement,Statement.class);
    ...
    public void b_read() {
        ...
        System.out.println("URL: " + url);
        ResponseEntity<Statement> response = restTemplate
                .withBasicAuth(SECURITY_USERNAME,SECURITY_PASSWORD)
                .getForEntity(url,Statement.class);
    ...
    public void c_update() {
        ...
        ResponseEntity<Statement> response = restTemplate
                .withBasicAuth(SECURITY_USERNAME,SECURITY_PASSWORD)
                .postForEntity(url,updated, Statement.class);
